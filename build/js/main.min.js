...
var _openMenu = require("./modules/open-menu");
var _animationIntro = require("./modules/animation-intro");
var _preloader = require("./modules/preloader");
var _initMap = require("./modules/initMap");
var _initMap2 = require("./modules/initMap2");
var _animationBlocks = require("./modules/animation-blocks");
var _scrollSlider = require("./modules/scroll-slider");
// ---------------------------------
(0, _preloader.initLoader)();
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  (0, _openMenu.initOpenMenu)();
  (0, _animationIntro.introItemAnimation)();
  (0, _initMap.initYaMap)();
  (0, _initMap2.initYaMapSecond)();
  (0, _animationBlocks.animateBlocks)();
  (0, _scrollSlider.initScrollSlider)();
...
},{"./modules/animation-blocks":2,"./modules/animation-intro":3,"./modules/form-validate/form":5,"./modules/initMap":11,"./modules/initMap2":12,"./modules/input-file/init-upload":17,"./modules/modals/init-modals":20,"./modules/open-menu":22,"./modules/preloader":23,"./modules/scroll-slider":24,"./modules/select/custom-select":26,"./utils/ios-vh-fix":29}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.animateBlocks = void 0;
var _gsap = require("../vendor/gsap.min");
var _scrollTrigger = require("../vendor/scroll-trigger.min");
_gsap.gsap.registerPlugin(_scrollTrigger.ScrollTrigger);
var animateBlocks = function animateBlocks() {
  _gsap.gsap.to('[data-element="fade"]', {
    scrollTrigger: {
  ...
  _gsap.gsap.to('[data-element="fade-in"]', {
    scrollTrigger: {
  ...
  _gsap.gsap.to('[data-element="fade-scale"]', {
    scrollTrigger: {
  ...
  _gsap.gsap.to('[data-element="transform1"]', {
    scrollTrigger: {
  ...
  _gsap.gsap.to('[data-element="fade-scale1"]', {
    scrollTrigger: {
...
exports.animateBlocks = animateBlocks;

},{"../vendor/gsap.min":32,"../vendor/scroll-trigger.min":33}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.introItemAnimation = void 0;
var _gsap = require("../vendor/gsap.min");
var introItemAnimation = function introItemAnimation() {
  setTimeout(function () {
    _gsap.gsap.fromTo('[data-attribute="intro-item"]', {
      duration: 1,
      scale: 0,
      x: -100,
      y: -100,
    ...
    _gsap.gsap.to('[data-element="title1"]', {
      duration: 1,
      y: 0,
      opacity: 1,
      ease: 'power3.out'
    });
    _gsap.gsap.to('[data-element="title2"]', {
      duration: 1,
      y: 0,
      opacity: 1,
      ease: 'power3.out',
    ...
    _gsap.gsap.to('[data-element="pargraph1"]', {
      duration: 1,
      y: 0,
      opacity: 1,
      ease: 'power3.out'
    });
    _gsap.gsap.to('[data-element="pargraph2"]', {
      duration: 1,
      y: 0,
      opacity: 1,
      ease: 'power3.out',
    ...
    _gsap.gsap.to('[data-element="pargraph3"]', {
      duration: 1,
      y: 0,
      opacity: 1,
      ease: 'power3.out',
...
exports.introItemAnimation = introItemAnimation;

},{"../vendor/gsap.min":32}],4:[function(require,module,exports){
"use strict";
...
exports.initYaMap = void 0;
var initYaMap = function initYaMap() {
  var mapYandex = document.getElementById('map');
  var firstCoordinates = 43.877557;
  var secondCoordinates = 10.260566;
  var myMap;
...
exports.initYaMapSecond = void 0;
var initYaMapSecond = function initYaMapSecond() {
  var mapYandex = document.getElementById('map-2');
  var firstCoordinates = 43.877557;
  var secondCoordinates = 10.260566;
  var myMap;
  ymaps.ready(function initMap() {
    ...
    var myMarkOne = new ymaps.Placemark([43.862929, 10.239869], {
      hintContent: 'Метка',
    ...
    var myMarkSec = new ymaps.Placemark([43.874490, 10.242886], {
      hintContent: 'Метка',
    ...
    var myMarkThe = new ymaps.Placemark([43.870361, 10.239809], {
      hintContent: 'Метка',
    ...
    var myMarkFour = new ymaps.Placemark([43.864997, 10.258584], {
      hintContent: 'Метка',
    ...
    myMap.behaviors.disable(['rightMouseButtonMagnifier', 'scrollZoom']);
    myMap.geoObjects.add(myPlacemark).add(myMarkOne).add(myMarkSec).add(myMarkThe).add(myMarkFour);
    myMap.addCursor(YMaps.Cursor.GRAB);
  });
};
exports.initYaMapSecond = initYaMapSecond;
...
},{"../../utils/focus-lock":27,"../../utils/scroll-lock":31}],22:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initOpenMenu = void 0;
var openMenuBtn = document.querySelector('[data-element="open-menu"]');
var mainMenu = document.querySelector('[data-attribute="main-menu"]');
...
exports.initOpenMenu = initOpenMenu;
...
var initLoader = function initLoader() {
  var loaderElement = document.querySelector('[data-loader]');
  if (!loaderElement) {
    return;
  }
...
},{"../utils/scroll-lock":31}],24:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initScrollSlider = void 0;
var _gsap = require("../vendor/gsap.min");
var _scrollTrigger = require("../vendor/scroll-trigger.min");
_gsap.gsap.registerPlugin(_scrollTrigger.ScrollTrigger);
var initScrollSlider = function initScrollSlider() {
  var slide = document.querySelectorAll('[data-element="scrollSlider"]');
  for (var i = 0; i < slide.length; i++) {
    _gsap.gsap.to(slide[i], {
      scrollTrigger: {
        trigger: slide[i],
        start: 'center center',
        end: 'top top',
...
exports.initScrollSlider = initScrollSlider;

},{"../vendor/gsap.min":32,"../vendor/scroll-trigger.min":33}],25:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":28}],32:[function(require,module,exports){
"use strict";
